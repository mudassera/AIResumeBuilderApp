  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput
        ...
        onChangeText={(text) =>
          setResumeData({ ...resumeData, email: text })
        }
      ...
      <TextInput
        ...
        onChangeText={(text) =>
          setResumeData({ ...resumeData, phone: text })
        }
      ...
      <TextInput
        ...
        onChangeText={(text) =>
          setResumeData({ ...resumeData, address: text })
        }
      ...
      <TextInput
        ...
        onChangeText={(text) => setResumeData({ ...resumeData, skills: text.split(', ').map(skill => skill.trim()).filter(skill => skill) })}
